package com.microservices.demo.cloudstreamkafkaplayground.sec09.processor;

import com.microservices.demo.cloudstreamkafkaplayground.common.MessageConverter;
import com.microservices.demo.cloudstreamkafkaplayground.sec09.dto.DigitalDelivery;
import com.microservices.demo.cloudstreamkafkaplayground.sec09.dto.OrderEvent;
import com.microservices.demo.cloudstreamkafkaplayground.sec09.dto.OrderType;
import com.microservices.demo.cloudstreamkafkaplayground.sec09.dto.PhysicalDelivery;
...
public class FanOutProcessor {
    ...
    private Function<Flux<OrderEvent>, Flux<PhysicalDelivery>> toPhysicalDelivery(){
        return flux -> flux.map( e-> new PhysicalDelivery(e.productId(),
