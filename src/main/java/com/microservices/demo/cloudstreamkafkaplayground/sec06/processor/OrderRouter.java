package com.microservices.demo.cloudstreamkafkaplayground.sec06.processor;
...
import com.microservices.demo.cloudstreamkafkaplayground.sec06.dto.DigitalDelivery;
import com.microservices.demo.cloudstreamkafkaplayground.sec06.dto.OrderEvent;
import com.microservices.demo.cloudstreamkafkaplayground.sec06.dto.PhysicalDelivery;
...
//    private static final String PHYSICAL_DELIVERY_CHANNEL = "physical-delivery-out";
    ...
    private Message<?> route(Record<OrderEvent> event){
