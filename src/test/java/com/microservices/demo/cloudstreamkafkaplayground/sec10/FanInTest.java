package com.microservices.demo.cloudstreamkafkaplayground.sec10;
...
@TestPropertySource(properties = {
        ...
        "spring.cloud.stream.bindings.rhProducer-out-0.destination=relativeHumidity-topic",
        "spring.cloud.stream.bindings.processor-in-0.destination=temperature-topic",
        "spring.cloud.stream.bindings.processor-in-1.destination=relativeHumidity-topic",
