package com.microservices.demo.cloudstreamkafkaplayground.sec09;
...
import com.microservices.demo.cloudstreamkafkaplayground.sec05.dto.OrderType;
...
public class FanOutTestTuple extends AbstractIntegrationTest {
private static final Logger log = LoggerFactory.getLogger(FanOutTestTuple.class);
